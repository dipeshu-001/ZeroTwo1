  ...
  run = async (
    ...
    if (!parsedArgs.joined) {
      ...
      const nsfw = [
        ...
        { title: "nhentai-search", rowId: "rowid" },
        ...
        { title: "pornimg", rowId: "rowid2" },
        { title: "realboobs", rowId: "rowid2" },
        { title: "xnxx", rowId: "rowid2" },
      ];
      const pokemon = [
